...
<!--    <div >
	...
	<div id="booking" class="section" style="margin-top:0; position:relative; bottom: 10px;">
		<div class="section-center">
			<div class="container" style="position:relative; bottom: 50px; width:1000px;">
				<div class="row">
					<div class="booking-form">
						<form>
							...
							<div class="row">
								<div class="col-md-3">
									<div class="form-btn">
										<button class="submit-btn" style="position:relative; left: 380px; margin-top:30px;">Submit</button>
									</div>
								</div>
                                </div>
							</div>
