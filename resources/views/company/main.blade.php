    ...
    <nav>
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              <li><a href="section.order">show</a></li>
          ...
          <li>
              <label for="btn-1" class="show"> Company</label>
              <a href="#">Company</a>
              <ul>
                <li> <label for="btn-3" class="show">show +</label>
                  <a href="company.show">show <span class="fa fa-plus"></span></a>
                  <input type="checkbox" id="btn-3">
                
                  <li> <label for="btn-3" class="show">add +</label>
                      <a href="company.place">add <span class="fa fa-plus"></span></a>
                      <input type="checkbox" id="btn-3">
