    ...
    <div class="d-flex flex-column">
      ...
      <nav class="nav-menu">
       <ul>
            ...
            <li class><a href="{{ url('/customers.showAllMedicine') }}"><i class="bx bx-capsule"></i> <span>Medicine</span></a></li>
           <li><a href="{{ url('/customers.add') }}"><i class="bx bx-plus"></i> <span>add Customers </span></a></li>
