                ...
                <div class="row gx-5 align-items-center">
                    ...
                    <div class="col-lg-6 order-lg-1">
                        <div class="p-5">
                         ...
                         <form  id="myNewAccount" action="" method="POST" enctype="multipart/form-data">
                           <div class="row">
                         <div class="col-6">
                          ...
                          <div>
                            ...
                            <div class="input-group has-validation">
                              ...
                              <input type="text" class="form-control" id="validationCustomUsername" aria-describedby="inputGroupPrepend" name="uname"  value=""required>
                            </div>
                          </div>
                          ...
                          <div class="col-6">
                            ...
                            <input type="text" class="form-control" id="validationCustom04" name="number" value="" required>
                          </div>
<div class="col-6">
                            <div>
                            <label for="validationCustom04" class="form-label" style="color:rgb(175, 131, 145)">Password</label>
                            <input type="text" class="form-control" id="validationCustom04" name="password" value="" required>
                          </div>
