...
<body>
      ...
      <nav>
        ...
        <ul>
          ...
          <li>
            <label for="btn-1" class="show"> Enters</label>
            <a href="#">Enters</a>
            <ul>
              <li> <label for="btn-3" class="show">show</label>
                <a href="buy.show">show <span class="fa fa-plus"></span></a>
                <input type="checkbox" id="btn-3">
              
              </li>
              <li> <label for="btn-3" class="show"> add </label>
                <a href="buy.add"> add <span class="fa fa-plus"></span></a>
                <input type="checkbox" id="btn-3">
               
              </li>
              <li> <label for="btn-3" class="show">bells </label>
                <a href="show.showTodayB"> bells <span class="fa fa-plus"></span></a>
                <input type="checkbox" id="btn-3">
