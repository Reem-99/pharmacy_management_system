 ...
 <div class="input-group">
    ...
    <div id="booking" class="section" style="margin-top:0; position:relative; bottom: 10px;">
		<div class="section-center">
			<div class="container" style="position:relative; top: 50px; width:1000px;">
				<div class="row">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group" style="text-align:center; position:relative; left: 250px; margin-top:30px;">
										<span class="form-label">name of section</span>
										<input class="form-control input--style-3 js-datepicker" type="text" name="sname">
                                        <i class="zmdi zmdi-calendar-note input-icon js-btn-calendar"></i>
									</div>
								</div>
</div>                              
								...
								<div class="col-md-6">
									<div class="form-group" style="text-align:center; position:relative; left: 250px; margin-top:30px;">
										...
										<input class="form-control input--style-3 js-datepicker" type="text" name="Place">
                                        <i class="zmdi zmdi-calendar-note input-icon js-btn-calendar"></i>
									</div>
								</div>
                                </div>
